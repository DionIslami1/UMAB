...
<html>
	...
	<table>
	<tr>
	<h3>Kërko të dhënat e antarsimeve për modifikim</h3>
	</tr>
	<tr>
...
<?php
	...
	while($rresht = mysqli_fetch_array($sql)) { 		
			...
			echo "<td><a href=\"modifikoAntarsime.php?id_antarsimi=$rresht[id_antarsimi]\" class='button' class='button primary'>Modifiko</a> </td>";			
		}
