					...
					<article id="main">
						...
						<section class="wrapper style5">
							<div class="inner">
								...
								<h3><strong>Forma per shtimin e </strong>Perdoruesve</h3>
									<form method="post" action="shtoPerdorues.php">
										<div class="row gtr-uniform">
											...
											<div class="col-6 col-12-xsmall">
												<input type="text" name="emaili" id="emaili" value="" placeholder="Emaili" />
											</div>
											<div class="col-6 col-12-xsmall">
												<input type="text" name="nr_telefonit" id="nr_telefonit" value="" placeholder="Nr.Telefonit" />
											</div>
											
											<div style="padding-left: 5% " class="col-12">
												<ul class="actions">
													<input type="submit" name="shtoPerdorues" value="shtoPerdorues" class="primary" />
