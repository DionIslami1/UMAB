						...
						<section class="wrapper style5">
							<div class="inner">
								...
								<ul class="features">
									...
									<table>
	<tr>
	<h3>Kërko të dhënat e ankesave për Fshirje</h3>
	</tr>
	<tr>
...
$sql = mysqli_query($kon,
	"CALL selectTermAnkesat('$p_term')");
while($rresht = mysqli_fetch_array($sql)) { 		
		echo "<tr>";
		echo "<td>".$rresht['subjekti']."</td>";
		echo "<td>".$rresht['ankesa']."</td>";
		echo "<td>".$rresht['emaili']."</td>";
		echo "<td><a href=\"fshijeAnkesa.php?id_ankesa=$rresht[id_ankesa]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini Ankesen?')\" class='button' class='button primary'>Fshijë</a>
		</td></tr>";
