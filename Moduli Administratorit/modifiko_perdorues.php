						...
						<section class="wrapper style5">
							<div class="inner">
								...
								<ul class="features">
									...
									<table>
	<tr>
	<h3>Kërko të dhënat e perdoruesin për modifikim</h3>
	</tr>
	<tr>
...
while($rresht = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"modifikoPerdorues.php?id_p=$rresht[id_p]\" class='button' class='button primary'>
		Modifiko</a></td></tr>";
