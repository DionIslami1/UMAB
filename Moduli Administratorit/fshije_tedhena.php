...
<html>
	...
	<td>
	<input type="text" name="term" placeholder="Titulli ose Pamja Faqes"/>
</td>
...
while($rresht = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"fshijeTedhena.php?id_tedhenat=$rresht[id_tedhenat]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini tedhenat?')\" class='button' class='button primary'>Fshijë</a></td></tr>";		
