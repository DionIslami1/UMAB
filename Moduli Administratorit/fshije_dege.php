...
<html>
	...
	<table>
	<tr>
	<h3>Kërko të dhënat e degeve për fshirje</h3>
	</tr>
	<tr>
...
while($rresht = mysqli_fetch_array($sql)) { 		
		...
		echo "<td><a href=\"fshijeDege.php?id_dega=$rresht[id_dega]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini degen?')\" class='button' class='button primary'>Fshijë</a>
		</td></tr>";		
	}
